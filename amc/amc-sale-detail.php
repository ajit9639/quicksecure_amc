...
$idd=$_GET['amcsid'];
$pmmode="";$dlrid="";
        $sql = "SELECT a.*,c.staff_name FROM tbl_amc_sale a, tbl_staff_master b, tbl_staff_master c where a.id='$idd' and a.staffid=b.staffid order by a.id desc";
        ...
        $query = $conn->query($sql);
         ...
         $sql1 = "SELECT * FROM tbl_dealer where dealer_name='$dlrname' order by id desc";
        $query1 = $conn->query($sql1);
        
          if($row1 = $query1->fetch_assoc()){$dlrid=$row1['dealerid'];$_SESSION['dealerid'] = $row1['dealerid'];}
            ...
            <tr>
              ...
              <td valign='center'><font>".$dlrname.' : '.$dlrid."</font></td>
              <td><strong>Staff Name </strong></td><td><strong>:</strong></td>
              <td valign='center'><font>".$row['staff_name'].' : '.$row['staffid']."</font></td>
            </tr>    
            ...
            <tr>  
              ...
              <a href='upload/".$attchmt."' class='btn btn-success' target='_blank'>Attacment</a>
            ...
            <td><strong>Remark </strong></td><td><strong>:</strong></td><td>".$row['payment_remarks']."</td>
          </tr>
            ";
                  ...
                  ?>
                                    ...
                                    <form action="print-amc-sale.php?amcsid=<?php echo $_GET['amcsid'];?>" method="post"
