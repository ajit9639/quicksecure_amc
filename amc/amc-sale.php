...
<input type="hidden" name="txtDealerName" id="txtDealerName" value="<?php echo $_SESSION['dlrnm'];?>">
...
<!-- #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ -->        
    <div class="form-group">
      ...
      <label for="txtYrofAMC" class="col-sm-2 control-label">Year of AMC</label>
        ...
        <input type="text" class="form-control pull-right" id="txtYrofAMC" name="txtYrofAMC" value="<?php echo $duration1;?>" readonly>
         <!-- <select class="form-control" name="txtYrofAMC" id="txtYrofAMC">
            <option value="<?php echo $duration1;?>" selected='selected' readonly><?php // echo $duration1;?></option>
            <option value="-" selected>--Select--</option> 
