...
include 'includes/session.php';
	...
	if($_POST['action'] == 'add1'){
		...
		$sql = "update tbl_amc_sale_dealer set item_type='$tItemType',purchase_year='$tPurchaseYear',item_category='$tItemCategory',brand_name='$tBrandName',item_description='$tItemDescription',package_name='$tPackageName',no_year='$tYrofAMC',qty='$tQTY',basic_price='$tPrice',gst='$tGST',tot_amt='$tTotAmt' where id='$tID'";
