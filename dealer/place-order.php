...
$ordrid = $dealer_id_name.'-LD-'. ($tempid + 1);
?>   

    <td><input type="text" name="txtOrderID" id="txtOrderID" class="form-control" value="<?php echo $ordrid;?>" readonly></td>
    <td>&nbsp;&nbsp;</td>
    <td>Date</td>
    <td colspan="2"><input type="text" name="txtDate" id="txtDate" class="form-control" value="<?php echo date('d-m-Y');?>"></td>
  ...
  <tr>
    <td width="20%">
                <div class="form-group">
                  <label>Model No.</label>
                    <select class="form-control" name="txtModelno" id="txtModelno"  onchange="javascript:changeSID();">
    ...
    <td width="20%">
                <div class="form-group">
                  ...
                  <input type="text" name="txtProcessor" id="txtProcessor" class="form-control" value="<?php echo $proc;?>" placeholder="Enter ...">
                </div>      
    </td>
    <td width="10%">&nbsp;&nbsp;</td>
    <td width="20%">
                <div class="form-group">
                  <label>RAM</label>
                  <input type="text" name="txtRam" id="txtRam" class="form-control" value="<?php echo $ram2;?>" placeholder="Enter ...">
                </div>      
    </td>
</tr>
<tr>    
    <td>
                <div class="form-group">
                  <label>HDD/SSD</label>
                  <input type="text" name="txtHddSsd" id="txtHddSsd" class="form-control" value="<?php echo $hddssd2;?>" placeholder="Enter ...">
                </div>      
    </td>
    <td>&nbsp;&nbsp;</td>
    <td>
                <div class="form-group">
                  <label>OS</label>
                  <input type="text" name="txtOS" id="txtOS" class="form-control" value="<?php echo $os2;?>" placeholder="Enter ...">
                </div>      
    </td>
    <td>&nbsp;&nbsp;</td>
    <td>
                <div class="form-group">
                  ...
                  <input type="text" name="txtGraphics" id="txtGraphics" class="form-control" value="<?php echo $graphics2;?>" placeholder="Enter ...">
                </div>      
    </td>
  </tr>
  <tr>
    <td>
                <div class="form-group">
                  <label>Display</label>
                  <input type="text" name="txtDisplay" id="txtDisplay" class="form-control" value="<?php echo $display2;?>" placeholder="Enter ...">
                </div>      
    </td>
    <td>&nbsp;&nbsp;</td>
    <td>
    ...
    <td>
                <div class="form-group">
                  ...
                  <input type="text" name="txtPrice" id="txtPrice" value="<?php echo $rt;?>" class="form-control" placeholder="Enter ..." readonly>
                </div>      
    </td>
</tr>
...
<tr>
    <td>
                <div class="form-group">
                  ...
                  <input type="text" name="txtTotal" id="txtTotal" class="form-control" placeholder="Enter ..." readonly>
                </div>      
    </td>
    <td>&nbsp;&nbsp;</td>
    <td>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control pull-right" id="txtExPrice" name="txtExPrice" readonly>
                </div>      
    </td>
    <td>&nbsp;&nbsp;</td>
    <td>
...
<!-- //gst -->
  ...
  <tr><?php $dlid=$_SESSION['id'];?>
    <td><a href="ins-order-data.php?dlrid=<?php $dlid;?>" class="btn btn-success btn-flat">
            <i class="fa fa-save"></i> Save</a></td>
            
    <td><button type="submit" id="add1" class="btn btn-primary btn-flat" name="add1">
...
<script type="text/javascript">
  $(function(){
    ...
    var total_price = $('#txtTotPrice').val();
      ...
      $.post('ins_data.php',{action: "add1", txtOrderID:txtOrderID,txtModelno:txtModelno1,txtProcessor:txtProcessor1,txtRam:txtRam1,txtHddSsd:txtHddSsd1,txtOS:txtOS1,txtGraphics:txtGraphics1,txtDisplay:txtDisplay1,txtQTY:txtQTY1,    txtPrice:unit_price, txtTotal:inclusive_price, txtExPrice:exclusive_price, txtGST:gst_percentage, txtGSTAmt:gst_amount, txtTotPrice:total_price },function(res){
        $('#result').html(res);
      });   
...
$( function() {
        ...
        $( "#txtModelno" ).OnChange({
            ...
            select: function (event, ui) {
                $('#txtProcessor').val(ui.item.label); // display the selected text
                $('#txtRam').val(ui.item.value); // save selected id to input        
                return false;
            },
