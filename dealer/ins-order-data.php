...
$ordrid = $dealer_id_name1.'-LD-'. ($tempid + 1);
...
//=============================================================
	...
	// $sql = "INSERT INTO tbl_order (type,orderid,order_date,dealer_id,dealer_name,product,modalno,processor1,ram1,hddssd,os1,graphics1,display1,    qty,unit_price,inclusive_price,exclusive_price,gst_percentage,gst_amount,total_price,order_status,all_total) VALUES ('dealer','$ordrid','$dt','$dealerid2','$dlrname','$pro','$modalno2','$processor2','$ram2','$hddssd2','$os2','$graphics2','$display2',      '$qty2','$unit_price','$inclusive_price','$exclusive_price','$gst_percentage','$gst_amount','$total_price','pending','$all_total')";
	mysqli_query($conn , $sql22 = "INSERT INTO tbl_order (type,orderid,order_date,dealer_id,dealer_name,product,modalno,processor1,ram1,hddssd,os1,graphics1,display1,    qty,unit_price,inclusive_price,exclusive_price,gst_percentage,gst_amount,total_price,order_status,all_total) VALUES ('dealer','$ordrid','$dt','$dealerid2','$dlrname','$pro','$modalno2','$processor2','$ram2','$hddssd2','$os2','$graphics2','$display2',      '$qty2','$unit_price','$inclusive_price','$exclusive_price','$gst_percentage','$gst_amount','$total_price','pending','$all_total')");
