...
include 'includes/session.php';
	...
	if($_POST['action'] == 'add1'){
		...
		$sql = "insert into tbl_periferals (pcode,item_name,brand_name,color_name,qty,price,gst,gstamt,totalamt) values('$pcode','$tItemName','$tBrandName','$tColorName','$tQty','$tPrice','$tGST','$tGSTAmt','$tTotPrice')";
