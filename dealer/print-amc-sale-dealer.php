        ...
        $query1 = $conn->query($sql1);
          if($row1 = $query1->fetch_assoc()){$dlrid=$row1['dealerid'];}
            ...
            <tr>
              ...
              <td valign='center' colspan='3'><font size='5'>".$row1['dealer_name'].' : '.$dlrid."</font></td>
...
?>
    ...
    // move the uploaded (temporary) file to the specified destination
		...
		$sql = "UPDATE `tbl_dealer_attachment` SET `payment_mode`='$pmode', remarks='$tRemarks', attachment='$filename' where id='$idd'";
