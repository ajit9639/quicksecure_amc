...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>New Assignation</h1>
      <ol class="breadcrumb">
        <li><a href="./"><i class="fa fa-dashboard"></i> Home</a></li>
    
        <li class="active">New Assignation</li>
      </ol>
    </section>
 ...
 <script type="text/javascript">
      ...
      var txtAssignTo1 = $('#txtAssignTo').val();
			...
			//syntax - $.post('filename', {data}, function(response){});
				$.post('insert-assigned-data.php',{action: "add1", txtDesignation:txtDesignation1,txtAssignTo:txtAssignTo1},function(res){
					$('#result').html(res);
				});		
...
<div class="form-horizontal">
  ...
  <div class="form-group">
      ...
      <label for="txtAssignTo" class="col-sm-2 control-label">Assign To</label>
        <div class="col-sm-4">
          <input type="text" class="form-control pull-right" id="txtAssignTo" name="txtAssignTo">
        </div>      
   </div> 
