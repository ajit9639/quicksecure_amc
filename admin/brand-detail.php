        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="brand-entry.php" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i>&nbsp;Add New Brand</a>
            </div>
            <div class="box-body">
        ...
        $query = $conn->query($sql);
          while($row = $query->fetch_assoc()){
            ...
            <tr>
              ...
              <td>".$row['brandname']."</td>
              <td>            
                <a href='brand-edit.php?id=".$row['id']."' class='btn btn-info btn-sm btn-flat'><i class='fa fa-edit'></i> Edit</a>
