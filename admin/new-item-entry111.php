      	...
      	<div class="col-sm-12">
            <div class="form-group">
                <div class="col-sm-12">
                   ...
                   <button type="submit" id="add1" class="btn btn-primary btn-flat pull-left" name="add1"><i class="fa fa-save"></i> Save</button>
                </div>
            </div>                  
      	</div>
  	</div>
