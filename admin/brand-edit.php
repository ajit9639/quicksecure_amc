...
<div class="wrapper">
 ...
 <script type="text/javascript">
      ...
      //syntax - $.post('filename', {data}, function(response){});
        $.post('brand-update.php',{action: "add1", txtID:txtID1,txtBrandName:txtBrandName1},function(res){
          $('#result').html(res);
        });   
...
<div class="form-horizontal">
  ...
  <div class="form-group">
      <label for="txtBrandName" class="col-sm-2 control-label">Brand Name</label>
        <div class="col-sm-4">
          <input type="text" class="form-control pull-right" id="txtBrandName" name="txtBrandName" value="<?php echo $itemname;?>">
        </div>
  </div>
