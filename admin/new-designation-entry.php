 ...
 <script type="text/javascript">
		$(function(){
			...
			//syntax - $.post('filename', {data}, function(response){});
				$.post('insert-designation-data.php',{action: "add1", txtDesignation:txtDesignation1},function(res){
					$('#result').html(res);
				});		
...
<div class="form-horizontal">
  ...
  <div class="form-group">
    	<label for="txtDesignation" class="col-sm-2 control-label">Designation</label>
	      <div class="col-sm-4">
	        <input type="text" class="form-control pull-right" id="txtDesignation" name="txtDesignation">
	      </div>
