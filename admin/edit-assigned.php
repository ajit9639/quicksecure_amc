...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Edit Assignation</h1>
      <ol class="breadcrumb">
        <li><a href="./"><i class="fa fa-dashboard"></i> Home</a></li>
    
        <li class="active">Edit Assignation</li>
      </ol>
    </section>
 ...
 <script type="text/javascript">
      ...
      var txtAssignTo1 = $('#txtAssignTo').val();
 

      //syntax - $.post('filename', {data}, function(response){});
        $.post('update-assigned-data.php',{action: "add1", txtID:txtID1,txtDesignation:txtDesignation1,txtAssignTo:txtAssignTo1},function(res){
          $('#result').html(res);
        });   
...
<div class="form-horizontal">
  <div class="box-body">
      ...
      <!--<label for="txtBillNo" class="col-sm-2 control-label">ID</label>-->
        ...
        <div class="col-sm-4">
            <?php
            $id=$_GET['id'];
             $sql = "SELECT * FROM tbl_assigned where id='$id'";
              $query = $conn->query($sql);
              if($crow = $query->fetch_assoc()){
                	$tID = $crow['id'];
                	$designation = $crow['designation'];
                  $tAssignTo = $crow['assignation'];
              }
  ...
  <div class="form-group">
      ...
      <label for="txtAssignTo" class="col-sm-2 control-label">Assign To</label>
        <div class="col-sm-4">
          <input type="text" class="form-control pull-right" id="txtAssignTo" name="txtAssignTo" value="<?php echo $tAssignTo;?>">
        </div>      
   </div> 
