...
<div class="wrapper">
 ...
 <script type="text/javascript">
      ...
      //syntax - $.post('filename', {data}, function(response){});
        $.post('update-package-data.php',{action: "add1", txtID:txtID1,txtPackageName:txtPackageName1},function(res){
          $('#result').html(res);
        });   
...
<div class="form-horizontal">
  ...
  <div class="form-group">
      <label for="txtPackageName" class="col-sm-2 control-label">Package Name</label>
        <div class="col-sm-4">
          <input type="text" class="form-control pull-right" id="txtPackageName" name="txtPackageName" value="<?php echo $Packagename;?>">
        </div>
  </div>
