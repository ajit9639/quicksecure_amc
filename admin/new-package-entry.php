  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">New Package Entry</li>
      </ol>
    </section>
 ...
 <script type="text/javascript">
		$(function(){
			...
			var txtPackageName1 = $('#txtPackageName').val();
				...
				$.post('insert-package-data.php',{action: "add1", txtPackageName:txtPackageName1},
          function(res){
					$('#result').html(res);
				});		
...
<div class="form-horizontal">
  ...
  <div class="form-group">
    	<label for="txtPackageName" class="col-sm-2 control-label">Package Name</label>
	      <div class="col-sm-4">
	        <input type="text" class="form-control pull-right" id="txtPackageName" name="txtPackageName">
	      </div>
