...
<strong>Phone:</strong> [1800-309-7011], 
...
<hr>
      ...
      <?php 
       ...
       $idd=$_GET['amcsid'];
        ...
        $sql = "SELECT a.* FROM tbl_amc_sale a, tbl_staff_master b where a.id='$idd' and a.staffid=b.staffid order by a.id desc";
        ...
        $query = $conn->query($sql);
         ...
         $sql1 = "SELECT * FROM tbl_dealer where dealer_name='$row[dealer_name]' order by id desc";
        $query1 = $conn->query($sql1);
          if($row1 = $query1->fetch_assoc()){$dlrid=$row1['dealerid'];}
            ...
            <tr>
              ...
              <td valign='center'><font size='5'>".$row['dealer_name'].' : '.$dlrid."</font></td>
              <td><strong>Staff Name </strong></td><td><strong>:</strong></td>
              <td valign='center'><font size='5'>".$row['staffid']."</font></td>
            </tr>            
            <tr>
