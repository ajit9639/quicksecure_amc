 ...
 <script type="text/javascript">
		$(function(){
			...
			//syntax - $.post('filename', {data}, function(response){});
				$.post('loc-insert.php',{action: "add1", txtLoc:txtLoc1},function(res){
					$('#result').html(res);
				});		
...
<div class="form-horizontal">
  ...
  <div class="form-group">
    	<label for="txtLoc" class="col-sm-2 control-label">Location Name</label>
	      <div class="col-sm-4">
	        <input type="text" class="form-control pull-right" id="txtLoc" name="txtLoc">
	      </div>
