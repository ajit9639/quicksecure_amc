...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
       ...
       $sql = "SELECT * from `tbl_order` where `orderid`='$idd' || `type`='dealer'";
        ...
        $query1 = $conn->query($sql1);
          if($row1 = $query1->fetch_assoc()){
            $staffname = $row1['dealer_name'];
            $staffid = $row1['dealerid'];
            $staffcity = $row1['city'];
                                            ...
                                            <a href="../dealer/upload/<?php echo $row['attachment'] ?>" download="download" class="btn btn-danger btn-xs">Download</a>
                                            </td>
