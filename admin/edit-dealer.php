...
<div class="wrapper">
 ...
 <script type="text/javascript">
      ...
      //syntax - $.post('filename', {data}, function(response){});
        $.post('update-dealer-data.php',{action: "add1", txtID:txtID1,txtDealerName:txtDealerName1,txtStoreName:txtStoreName1,txtAddress:txtAddress1,txtCity:txtCity1,txtState:txtState1,txtPinNo:txtPinNo1,txtGST:txtGST1,txtPhNo:txtPhNo1,txtEMail:txtEMail1,txtStatus:txtStatus1,txtUserid:txtUserid,txtPass:txtPass},function(res){
          $('#result').html(res);
        });   
...
<div class="form-horizontal">
  <div class="box-body">
      ...
      <!--<label for="txtBillNo" class="col-sm-2 control-label">ID</label>-->
        ...
        <div class="col-sm-4">
            <?php
              $id=$_GET['id'];
             $sql = "SELECT * FROM tbl_dealer where id='$id'";
              $query = $conn->query($sql);
              if($crow = $query->fetch_assoc()){
                	$tID = $crow['id'];

                	$dealername = $crow['dealer_name'];
									$storename = $crow['store_name'];
  ...
  <div class="form-group">
      <label for="txtDealerName" class="col-sm-2 control-label">Dealer Name</label>
        <div class="col-sm-4">
          <input type="text" class="form-control pull-right" id="txtDealerName" name="txtDealerName" value="<?php echo $dealername;?>">
        </div>
      
      <label for="txtStoreName" class="col-sm-2 control-label">Store Name</label>
        <div class="col-sm-4">
          <input type="text" class="form-control pull-right" id="txtStoreName" name="txtStoreName" value="<?php echo $storename ;?>">
        </div>  
  ...
  <div class="form-group">
      <label for="txtAddress" class="col-sm-2 control-label">Address</label>
        <div class="col-sm-4">
          <input type="text" class="form-control pull-right" id="txtAddress" name="txtAddress" value="<?php echo $address;?>">
        </div>
...
<!-- #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ #@ -->        
  ...
  <div class="form-group">
      <label for="txtGST" class="col-sm-2 control-label">GST</label>
        <div class="col-sm-4">
          <input type="text" class="form-control pull-right" id="txtGST" name="txtGST" value="<?php echo $gst;?>">
        </div>
  ...
  <div class="form-group">
      <label for="txtUserid" class="col-sm-2 control-label">UserID</label>
        <div class="col-sm-4">
          <input type="text" class="form-control pull-right" id="txtUserid" name="txtUserid" value="<?php echo $txtUserid;?>">
        </div>
      
      <label for="txtPass" class="col-sm-2 control-label">Password</label>

        <div class="col-sm-4">
          <input type="text" class="form-control pull-right" id="txtPass" name="txtPass" value="<?php echo $txtPass;?>">
        </div>  
