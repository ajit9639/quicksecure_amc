    ...
    <div class="wrapper">
       ...
       $sql = "SELECT * from `tbl_order_peripheral` where `orderid`='$idd'";
        ...
        if($row1 = $query1->fetch_assoc()){
            ...
            $staff_name = $row1['dealer_name'];
            $staff_id = $row1['dealerid'];
...
$sql12 = mysqli_query($conn , "SELECT  sum(exclusive_price) as ex,sum(gst_amount) as gst,sum(total_price) as Total from `tbl_order_peripheral` where `orderid`='$idd'");
...
?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan='2'><?php echo $row22['ex'] ?></td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan='2'><?php echo $row22['gst'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="9"></td>
                                                    <td colspan='2'><strong>Total Price </strong></td>
                                                    <td colspan='2'><?php echo $row22['Total'] ?></td>
                                                </tr>
