...
$get_all = mysqli_fetch_assoc(mysqli_query($conn , "select * from `tbl_order_peripheral` WHERE `orderid`='$id'"));
 ...
 if(isset($_POST['update_me'])){
    ...
    if($update){
        echo "<script>window.location.replace('order-detail-peripheral-staff.php')</script>";
    }
}
?>
